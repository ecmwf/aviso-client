...
### D-E4. Each example is fact-checked end-to-end against `aviso.example.org`
...
- Doc-examples harness extended to walk `python/examples/**/*.py`; every example runs against `aviso.example.org` with the sidecar publisher; all pass.
